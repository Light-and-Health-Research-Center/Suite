...
export default function BackgroundLuminance() {
  const RVP = useRVP();
  return (
    <div className="bg-white-100 shadow-blueGray rounded-md h-48">
      ...
      <h4 className="text-blueGray-900 text-sm font-bold uppercase text-center px-6">
      ...
      <div className="p-4">
        <div className="bg-blueGray-100 rounded-lg mx-6 focus-within:ring-2 ring-sky-700 ring-offset-4">
          <input
            ...
            value={RVP.backgroundLuminance}
            onChange={(e) => {
              RVP.setBackgroundLuminance(e.target.value);
            }}
          />
